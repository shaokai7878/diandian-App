...
/**
 * Generated class for the SheyingPopPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-sheying-pop',
  templateUrl: 'sheying-pop.html',
})
export class SheyingPopPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad SheyingPopPage');
  }
